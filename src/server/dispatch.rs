use slipbox_rpc::{
    ...
    METHOD_CAPTURE_TEMPLATE_PREVIEW, METHOD_COMPARE_NOTES, METHOD_DEMOTE_ENTIRE_FILE,
    METHOD_ENSURE_FILE_NODE, METHOD_ENSURE_NODE_ID, METHOD_EXPLORE, METHOD_EXTRACT_SUBTREE,
    METHOD_FORWARD_LINKS, METHOD_GRAPH_DOT, METHOD_INDEX, METHOD_INDEX_FILE, METHOD_INDEXED_FILES,
    ...
    METHOD_REFILE_REGION, METHOD_REFILE_SUBTREE, METHOD_REFLINKS, METHOD_SEARCH_FILES,
