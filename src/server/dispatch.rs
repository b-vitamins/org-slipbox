use slipbox_rpc::{
    ...
    METHOD_CAPTURE_TEMPLATE_PREVIEW, METHOD_COMPARE_NOTES, METHOD_DELETE_EXPLORATION_ARTIFACT,
    METHOD_DEMOTE_ENTIRE_FILE, METHOD_ENSURE_FILE_NODE, METHOD_ENSURE_NODE_ID,
