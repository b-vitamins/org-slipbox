use slipbox_rpc::{
    ...
    METHOD_ENSURE_NODE_ID, METHOD_EXTRACT_SUBTREE, METHOD_GRAPH_DOT, METHOD_INDEX,
    METHOD_INDEX_FILE, METHOD_INDEXED_FILES, METHOD_NODE_AT_POINT, METHOD_NODE_FROM_ID,
    METHOD_NODE_FROM_REF, METHOD_NODE_FROM_TITLE_OR_ALIAS, METHOD_PING, METHOD_PROMOTE_ENTIRE_FILE,
    METHOD_RANDOM_NODE, METHOD_REFILE_REGION, METHOD_REFILE_SUBTREE, METHOD_SEARCH_NODES,
    METHOD_SEARCH_REFS, METHOD_SEARCH_TAGS, METHOD_STATUS, METHOD_UPDATE_NODE_METADATA,
};
