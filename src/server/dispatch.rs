use slipbox_rpc::{
    ...
    METHOD_EXPLORATION_ARTIFACT, METHOD_EXPLORE, METHOD_EXTRACT_SUBTREE, METHOD_FORWARD_LINKS,
    METHOD_GRAPH_DOT, METHOD_INDEX, METHOD_INDEX_FILE, METHOD_INDEXED_FILES,
    ...
    METHOD_REVIEW_RUN, METHOD_RUN_WORKFLOW, METHOD_SAVE_EXPLORATION_ARTIFACT,
    METHOD_SAVE_REVIEW_RUN, METHOD_SEARCH_FILES, METHOD_SEARCH_NODES, METHOD_SEARCH_OCCURRENCES,
    METHOD_SEARCH_REFS, METHOD_SEARCH_TAGS, METHOD_STATUS, METHOD_UNLINKED_REFERENCES,
    METHOD_UPDATE_NODE_METADATA, METHOD_WORKFLOW,
};
