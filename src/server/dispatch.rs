...
fn dispatch_request(
    ...
    match method {
        ...
        METHOD_DIAGNOSE_FILE => query::diagnose_file(state, params),
        METHOD_DIAGNOSE_NODE => query::diagnose_node(state, params),
        METHOD_DIAGNOSE_INDEX => query::diagnose_index(state),
        ...
        METHOD_REVIEW_FINDING_REMEDIATION_PREVIEW => {
            query::review_finding_remediation_preview(state, params)
        }
        METHOD_REVIEW_FINDING_REMEDIATION_APPLY => {
            query::review_finding_remediation_apply(state, params)
        }
        ...
        METHOD_IMPORT_WORKBENCH_PACK => query::import_workbench_pack(state, params),
        METHOD_WORKBENCH_PACK => query::workbench_pack(state, params),
        METHOD_VALIDATE_WORKBENCH_PACK => query::validate_workbench_pack(state, params),
        METHOD_EXPORT_WORKBENCH_PACK => query::export_workbench_pack(state, params),
        METHOD_LIST_WORKBENCH_PACKS => query::list_workbench_packs(state, params),
        METHOD_DELETE_WORKBENCH_PACK => query::delete_workbench_pack(state, params),
        ...
        METHOD_LIST_REVIEW_ROUTINES => query::list_review_routines(state, params),
        METHOD_REVIEW_ROUTINE => query::review_routine(state, params),
        METHOD_RUN_REVIEW_ROUTINE => query::run_review_routine(state, params),
