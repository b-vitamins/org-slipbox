use slipbox_rpc::{
    ...
    METHOD_DELETE_EXPLORATION_ARTIFACT, METHOD_DEMOTE_ENTIRE_FILE, METHOD_ENSURE_FILE_NODE,
    METHOD_ENSURE_NODE_ID, METHOD_EXECUTE_EXPLORATION_ARTIFACT, METHOD_EXPLORATION_ARTIFACT,
    METHOD_EXPLORE, METHOD_EXTRACT_SUBTREE, METHOD_FORWARD_LINKS, METHOD_GRAPH_DOT, METHOD_INDEX,
    ...
    METHOD_RUN_WORKFLOW, METHOD_SAVE_EXPLORATION_ARTIFACT, METHOD_SEARCH_FILES,
    METHOD_SEARCH_NODES, METHOD_SEARCH_OCCURRENCES, METHOD_SEARCH_REFS, METHOD_SEARCH_TAGS,
    METHOD_STATUS, METHOD_UNLINKED_REFERENCES, METHOD_UPDATE_NODE_METADATA, METHOD_WORKFLOW,
};
