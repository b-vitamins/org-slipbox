...
/// search always resolves at least one term.
pub(crate) const GLOSSARY_QUERY: &str = "Headword";
/// Node key of the glossary term the grade benchmark repeatedly reschedules.
pub(crate) const GLOSSARY_GRADE_NODE_KEY: &str = "file:notes/glossary-term-0000.org";
/// Fixed reference date for the glossary grade benchmark, keeping the SM-2
/// arithmetic deterministic across runs.
pub(crate) const GLOSSARY_TODAY: &str = "2026-07-22";
